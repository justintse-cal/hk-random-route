...
export function BrandArrowIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
      ...
      aria-hidden="true"
    >
      <path d="M13.5 4.5 21 12l-7.5 7.5v-4.75H3v-5.5h10.5z" />
    </svg>
  );
}
...
export function BookmarkIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M17 11v6.97l-5-2.14-5 2.14V5h6V3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V11h-2zM21 7h-2v2h-2V7h-2V5h2V3h2v2h2v2z" />
    </svg>
  );
}

export function AddLocationAltIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ElevationIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function LegendIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M4 7h16v1.5H4zm0 4.25h12v1.5H4zm0 4.25h16v1.5H4z" />
    </svg>
  );
}
